...
import { Search, QrCode, Receipt, LogOut, Loader2, AlertCircle, Users, RefreshCw, BarChart2 } from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-950 text-white">
      <header className="sticky top-0 z-10 bg-slate-950/95 backdrop-blur border-b border-slate-800 px-4 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <Link to="/staff/dashboard" className="text-xs text-slate-400 hover:text-white inline-flex items-center gap-1" title="Dashboard de mètriques">
