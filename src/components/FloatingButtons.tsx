...
const SHARE_TEXT = "🏀 3×3 Westfield Glòries 2026 · Torneig FIBA a Barcelona · 100 equips · 6-7 Juny · 2.400€ prize money (Sèniors M/F · Veterans M/F). Inscriu-te ja!";
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-5 right-5 z-[55] flex items-center gap-2.5 bg-[#25D366] hover:bg-[#1da851] active:scale-95 transition-all text-white px-5 py-4 rounded-full shadow-xl shadow-green-500/40 ring-2 ring-white/10 motion-safe:animate-pulse motion-safe:hover:animate-none"
      >
